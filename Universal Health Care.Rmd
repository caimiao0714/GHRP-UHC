---
title: "Association between Primary Care Investment and Life Expectency in 193 Countries: A Retrospective Longitudinal Study"
subtitle: 
author:
  - name: Miao Cai
...
```{r fig1, eval=TRUE,fig.cap='Life expectancy in different countries from 2000 to 2015'}
...
DELETE- Government Financing Arrangements (GFA) as % of CHE:	GFACHE_SHA2011
- Compulsory Health Insurance (CHI) as % of (CHE): CHICHE_SHA2011
...
```{r}
fit00 = lm(
  Lifeexpectancy ~  CHEGDP_SHA2011 + GGHEDCHE_SHA2011 + PVTDCHE_SHA2011 + 
    GGHEDGDP_SHA2011 + CFACHE_SHA2011 + GFACHE_SHA2011 + CHICHE_SHA2011 + 
    OOPSCHE_SHA2011 + Year + IncomeGroup, 
  data = f1)
broom::tidy(fit00)
#summary(fit00)
```
...
f1 = f0 %>% 
  select(`Country Income Group`, Lifeexpectancy,  CHEGDP_SHA2011, GGHEDCHE_SHA2011,
         PVTDCHE_SHA2011, CountryName, GGHEDGDP_SHA2011, CFACHE_SHA2011, 
         GFACHE_SHA2011, CHICHE_SHA2011, OOPSCHE_SHA2011, Year) %>% 
  na.omit()
...
fit01 = lm(
  Lifeexpectancy ~  CHEGDP_SHA2011 + GGHEDCHE_SHA2011 + PVTDCHE_SHA2011 + 
    GGHEDGDP_SHA2011 + CFACHE_SHA2011 + CHICHE_SHA2011 + 
    OOPSCHE_SHA2011 + Year + `Country Income Group`, 
  data = f1)
broom::tidy(fit01)
#summary(fit01)
